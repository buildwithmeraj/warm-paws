  ...
  return (
    <div className="mt-8">
      ...
      <div className="grid grid-cols-3 justify-items-center py-4 rounded-2xl text-xl font-semibold">
        <div className="bg-gradient-to-r from-amber-100 via-orange-100 to-amber-200 outline-2 outline-offset-2 outline-dashed outline-amber-600 p-6 rounded-xl flex flex-col gap-1 text-center w-md animate__animated animate__headShake animate__infinite animate__slow">
